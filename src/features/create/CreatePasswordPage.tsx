            ...
            <Tooltip className="create-password-page__tooltip">
              <ul className="create-password-page__required-list">
                <li className={clsx(`create-password-page__validation-item`, {
                  'create-password-page__validation-item--valid': minLenght, 
                })}>
                ...
                <li className={clsx(`create-password-page__validation-item`, {
                  'create-password-page__validation-item--valid': isContainsUppercaseLetter, 
                })}>
                  <span className="create-password-page__checkbox">
                ...
                <li className={clsx(`create-password-page__validation-item`, {
                  'create-password-page__validation-item--valid': isContainsLowercaseLetter, 
                })}>
                  <span className="create-password-page__checkbox">
                ...
                <li className={clsx(`create-password-page__validation-item`, {
                  'create-password-page__validation-item--valid': isContainsNumber, 
                })}>
                  <span className="create-password-page__checkbox">
                ...
                <li className={clsx(`create-password-page__validation-item`, {
                  'create-password-page__validation-item--valid': isContainsSpecialCharacters, 
                })}>
                  <span className="create-password-page__checkbox">
